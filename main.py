...
def delete_person(p_id: int):
    ...
    if len(person) > 0:
        ...
        raise HTTPException(status_code=404, detail=f"There is no preson with id{p_id}")
...
#THIS A SIMPLE TEST FOR THE REST API
# @app.get('/')
# def car():
#     return {"I Like": "Benz"}
...
# @app.post('/')
# def car_post():
#     return {"Success": "You Purchased a S-Class Benz"}
